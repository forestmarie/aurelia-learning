...
// viewEngineHooks allows you to gain access to the data binding context right before the
// view is bound.  This allows us to augment the data that's available to bind to.
@viewEngineHooks()
export class CountryBinderViewEngineHook {
  beforeBind(view) {
